...
function App() {
  ...
  const addNewMeeting = () => {
    ...
    Axios.post("http://localhost:8080/add-meeting", {
      meetingTitle,
      date,
      content,
    });
  ...
  const sendAlertMeeting = () => {
    Axios.post("http://localhost:8080/alert-meeting", {
      selectedMeetingID,
      recipients,
      alertMessage,
    });
  ...
  const editCluster = id => {
    Axios.put(`http://localhost:8080/edit-cluster/${id}`, {
      toEditClusterID,
      toEditClusterName,
    });
  };
  ...
  const updateMember = id => {
    Axios.put(`http://localhost:8080/update-member/${id}`, {
      newName,
      newEmail,
    });
  };
  ...
  //add a member
  const addNewMember = () => {
    Axios.post("http://localhost:8080/add-member", {
      name,
      email,
      nickname,
      user_id,
  ...
  const submitPosts = () => {
    Axios.post("http://localhost:8080/submit-posts", {
      postListName,
      postArray,
    });
  };
  ...
  //Page_List
  const submitPages = () => {
    Axios.post("http://localhost:8080/submit-pages", {
      pageListName,
      pageArray,
    });
  };
  ...
  const tagPeople = (tagLink, clusterID, tagMessage) => {
    Axios.post(`http://localhost:8080/tag-people/`, {
      tagLink,
      recipients,
      tagMessage,
    });
  ...
  return (
    <div className="container">
      ...
      <input
        type="text"
        onChange={e => {
          setToEditClusterName(e.target.value);
        }}
      />
      <br />
      <button
      ...
      <div>
        ...
        <input
          type="text"
          onChange={e => {
            setPostListName(e.target.value);
          }}
        />
        <br />
        <br />
      ...
      <button
        className="delete-btn"
        onClick={() => {
          deletePostlist(displayPostListID);
        }}
      >
        Delete Post List
      </button>
      ...
      <button
        ...
        onClick={() => {
          tagPeople(tagLink, clusterID, tagMessage);
        }}
      >
        Tag People
      </button>
      ...
      <div>
        ...
        <input
          type="text"
          onChange={e => {
            setPageListName(e.target.value);
          }}
        />
        <br />
        <br />
      ...
      <button
        className="delete-btn"
        onClick={() => {
          deletePagelist(displayPageListID);
        }}
      >
        Delete Page List
      </button>
